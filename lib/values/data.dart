...
class Projects {
  ...
  static ProjectItemData BUAHTANGAN = ProjectItemData(
    ...
    image: ImagePath.BUAHTANGAN_COVER,
    coverUrl: ImagePath.BUAHTANGAN_COVER_DETAIL,
    ...
    projectAssets: [
      ImagePath.BUAHTANGAN_1,
      ImagePath.BUAHTANGAN_2,
      ImagePath.BUAHTANGAN_3,
      ImagePath.BUAHTANGAN_4,
      ImagePath.BUAHTANGAN_5,
      ImagePath.BUAHTANGAN_6,
      ImagePath.BUAHTANGAN_7,
      ImagePath.BUAHTANGAN_8,
      ImagePath.BUAHTANGAN_9,
      ImagePath.BUAHTANGAN_10,
    ],
    isPublic: true,
    technologyUsed: StringConst.FLUTTER,
